...
class Posts extends Component {
  ...
  render() {
    ...
    if (!this.state.isLoaded) {
      return <div>Our server must be down please try again later</div>;
    } else {
      return (
        <div id="wrapper">
          <div id="blogs">
          ...
          <div id="submit_blog">
            <form id="blog_form">
              ...
              <input
                className="input_field tit"
                onChange={this.setTitle}
                placeholder="TITLE"
              />
              <br />
              <input
                className="input_field aut"
                onChange={this.setAuthor}
                placeholder="AUTHOR"
              />
              <br />
              <textarea
                className="input_field bod"
                onChange={this.setBody}
                placeholder="YOUR POST HERE"
              />
              <br />
              <input
                className="input_field sub"
                type="submit"
